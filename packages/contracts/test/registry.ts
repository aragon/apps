...
describe('Registry', function () {
  ...
  it('Should register a new name successfully', async function () {
    ...
    await expect(await registry.register(daoName, daoAddress, ownerAddress, ownerAddress))
  ...
  it('Should revert if name already exists', async function () {
    ...
    await expect(registry.register(daoName, daoAddress, ownerAddress, ownerAddress))
